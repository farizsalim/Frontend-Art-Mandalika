...
const OrderPage = () => {
    ...
    const handlePaymentMethodChange = (method) => {
        ...
        setSelectedService(''); // Reset selected service when payment method changes
    };
    ...
    return (
        <div className="order-page-container">
            ...
            <PaymentMethodSelector paymentMethods={paymentMethods} selectedPaymentMethod={selectedPaymentMethod} handlePaymentMethodChange={handlePaymentMethodChange} handleServiceChange={handleServiceChange} selectedService={selectedService} />
